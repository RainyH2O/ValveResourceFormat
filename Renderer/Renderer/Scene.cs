...
namespace ValveResourceFormat.Renderer
{
    ...
    public class Scene : IDisposable
    {
        ...
        // Selection flags are read while building render lists on the render thread.
        internal static readonly Lock SelectionSynchronization = new();
        ...
        {
            using var _ = SelectionSynchronization.EnterScope();
