...
namespace ValveResourceFormat.TextureDecoders
{
    internal readonly struct DecodeRG1616F : ITextureDecoder
    {
        ...
        private static void DecodeHdr(SKPixmap pixels, ReadOnlySpan<RG1616F> inputPixels)
        {
        ...
        private static void DecodeLdr(SKPixmap pixels, ReadOnlySpan<RG1616F> inputPixels)
        {
