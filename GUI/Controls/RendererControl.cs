...
#pragma warning restore CA2213 // Disposable fields should be disposed
    ...
    public CheckedListBox AddMultiSelection(
        ...
        => AddMultiSelectionControl(name, initializeCallback, changeCallback, checkAllPredicate).CheckedListBox;

    public GLViewerMultiSelectionControl AddMultiSelectionControl(
        string name,
        Action<CheckedListBox>? initializeCallback,
        Action<IEnumerable<string>> changeCallback,
        Predicate<object>? checkAllPredicate = null)
