...
public class PropertySelectionDialog : Form
{
    ...
    private void SetupLayout()
    {
        ...
        Controls.AddRange(searchLabel, _searchTextBox, _expandAllButton, _collapseAllButton, availableLabel,
            ...
            _addSmartButton, _includeConnectionRelatedCheckBox, _includePropertyRelatedCheckBox, _okButton,
            _cancelButton);
    }
    ...
    private void OkButton_Click(object? sender, EventArgs e)
    {
        ...
        IncludeRelatedEntities = IncludeConnectionRelatedEntities || IncludePropertyRelatedEntities;

        FinalEntityList = IncludeRelatedEntities
            ? GetEntitiesWithRelated(_filteredEntities, _allEntities, IncludeConnectionRelatedEntities,
                IncludePropertyRelatedEntities)
        ...
        bool includePropertyRelated)
    {
        ...
        if (includePropertyRelated && includeConnectionRelated)
        {
            var entitiesAfterPropertySearch = FindEntitiesWithPropertyRelations(filteredEntities, namedEntitiesLookup);

            var entitiesByConnection = BuildConnectionLookup(allEntities);
            return FindEntitiesWithConnectionRelations(entitiesAfterPropertySearch, namedEntitiesLookup,
